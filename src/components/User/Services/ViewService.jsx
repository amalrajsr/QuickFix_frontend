...
import { fetchExpertsByService, fetchReviewsByServiceApi } from "../../../apis/user";
  ...
  const howItWorks = [
    {
      ...
      image: "https://res.cloudinary.com/dsw9tifez/image/upload/v1681399840/quickfix/static/client-check.6c4fbfd_nxyoqk.svg",
    },
    {
      message: "Experts will be Assigned",
      image: "https://res.cloudinary.com/dsw9tifez/image/upload/v1681399859/quickfix/static/clients-check.e5dd40e_oqr3gs.svg",
    },
    {
      message: "Our Expert will call you",
      image: "https://res.cloudinary.com/dsw9tifez/image/upload/v1681399879/quickfix/static/expert-call.d20448c_uatx5y.svg",
    },
    {
      message: "Our Experts at your place",
      image: "https://res.cloudinary.com/dsw9tifez/image/upload/v1681399897/quickfix/static/expert-delivery.903404f_nkml8q.svg",
    },
    {
      message: "Complete the job",
      image: "https://res.cloudinary.com/dsw9tifez/image/upload/v1681399910/quickfix/static/expert-support.84879b9_trwtij.svg",
    },
  ];
...
<section class="text-gray-600 body-font">
  <div class="container px-5 mb-10 mx-auto">
    ...
    <div class="flex flex-wrap -m-4">
      {reviews.map((data)=>{
     return <div class="p-4 md:w-1/3 w-full">
        <div class="h-full bg-gray-100 p-8 rounded">
          ...
          <p class="leading-relaxed  break-words mb-6">{data.review}</p>
          <p class="inline-flex items-center">
            <img alt="testimonial" src={data.user.avatar || "https://dummyimage.com/106x106"} class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium text-gray-900">{data.user.name}</span>
              <span class="text-gray-500 text-sm">{data.date.split('T')[0]}</span>
