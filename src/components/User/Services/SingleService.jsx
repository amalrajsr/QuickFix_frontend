...
function SingleService({data, image, title }) {
    return (
        ...
        <div className=" bg-white w-[200px] h-[150px] mx-auto  py-5 flex flex-col justify-between   hover:shadow-xl rounded-lg mt-5 mb-3 transition ease-in-out delay-5 duration-300 hover:-translate-y-1">
